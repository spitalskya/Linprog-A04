...
Využívame dáta zo súboru \verb|A04wine.csv| a aplikujeme modely $L^1$ a $L^{\infty}$ z úlohy A. Budeme využívať podobný postup ako v B. Na implementáciu formulovaných LP úloh využívame opäť:
\begin{itemize}
